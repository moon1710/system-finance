        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <div className="flex items-center justify-center mb-6 sm:mb-8 relative z-10">
              ...
              >
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 transform-gpu hover:translateZ-2 ${
                    !isAdmin
            ...
            <div className="mt-6 sm:mt-8 text-center relative z-10">
              <p className="text-gray-500 text-sm">Need assistance? Contact support</p>
            </div>
          </div>

          {/* Enhanced 3D info cards with glass effect */}
          <div className="mt-6 grid grid-cols-2 gap-4">
            <div
              className="backdrop-blur-xl bg-white/60 border border-white/20 rounded-xl p-4 transform-gpu transition-all duration-500 hover:translateY-2 hover:rotateX-3 hover:shadow-xl cursor-pointer relative overflow-hidden"
              style={{
                transformStyle: "preserve-3d",
                boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.2)",
              }}
            >
